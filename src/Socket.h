...
public:
    ...
    /**
     * Connects to the given address, and returns the resulting
     * SocketConnection.
    ...
    /**
     * Must be called periodically to process all incoming data to find new
     * connections
...
public:
    ...
    socklen_t get_addrlen() { return this->addrlen; }

    int get_my_id() { return this->my_id; }

    int get_their_id() { return this->their_id; }
};
