...
RoundCollisionResult CTFGame::roundWallCollision(std::shared_ptr<MovingRoundObject> obj1,
...
CTFGame::roundRoundCollision(std::shared_ptr<MovingRoundObject> obj1,
