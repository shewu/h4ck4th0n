...
Gets the flags for a given team. If an invalid team number is requested, returns the spawns for the first team.
...
Gets the spawns for a given team. If an invalid team number is requested, returns the spawns for the first team.
...
\begin{DoxyReturn}{Returns}
the team list containing \hyperlink{class_team}{Team} objects in no particular order. 
\end{DoxyReturn}
